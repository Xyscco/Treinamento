...
import br.com.syncode.enumerados.StatusPedidoold;
...
public class Pedido {
	...
	private StatusPedidoold status;
	...
	public Pedido(Long codPedido, Servico servico, int quantidade, Date dataSolicitacao, Date dataEntrega,
			Funcionario funcResponsavel, Cliente cliente, StatusPedidoold status) {
		super();
	...
	public StatusPedidoold getStatus() {
		return status;
	}

	public void setStatus(StatusPedidoold status) {
		this.status = status;
	}
